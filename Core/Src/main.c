...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOA, SPI1_CS_Pin|RS485_1_EN_Pin|RS485_2_EN_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, SPI2_CS_Pin|TFT_RESET_Pin|TFT_DC_Pin|TFT_LED_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : SPI1_CS_Pin RS485_1_EN_Pin RS485_2_EN_Pin */
  GPIO_InitStruct.Pin = SPI1_CS_Pin|RS485_1_EN_Pin|RS485_2_EN_Pin;
  ...
  /*Configure GPIO pins : SPI2_CS_Pin TFT_RESET_Pin TFT_DC_Pin TFT_LED_Pin */
  GPIO_InitStruct.Pin = SPI2_CS_Pin|TFT_RESET_Pin|TFT_DC_Pin|TFT_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
